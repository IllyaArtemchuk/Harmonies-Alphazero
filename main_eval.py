...
if __name__ == "__main__":
    ...
    loaded = best_model_mgr.load_checkpoint(folder=checkpoint_folder, filename=best_model_filename)
    
    if not loaded:
        print(f"ERROR: Could not load best model from {checkpoint_folder}/{best_model_filename}")
        exit()
